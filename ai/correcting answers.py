...
def analyze_interview_answers(interview_data):
    ...
    }عاوزه يطلع فى الاخر total score يكون مساوي لمجموع الscores كلها بتاعه كل سؤال وعاوزه كمان تطلع من 100+عاوزاك تتكلم معاه بطريقه friendly  ببالعاميه العربيه  كانك انسان زيه وتشجعه وكمان عاوزه المصادر اللى هتطلعهاله يذاكر منها تتنوع  بين لينكات يوتيوب ومواقع وكتب  لا تضف أي نصوص خارج الـ JSON.    
